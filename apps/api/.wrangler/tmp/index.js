...
async function seed(env) {
  ...
  try {
    ...
    const menusData = [
      { id: ulid(), label: "T\u1ED5ng quan", icon: "Home", path: "/", permissionSlug: "dashboard:view", appSlug: null, position: 1 },
      { id: ulid(), label: "Ng\u01B0\u1EDDi d\xF9ng", icon: "Users", path: "/users", permissionSlug: "users:view", appSlug: null, position: 90 },
      { id: ulid(), label: "Th\u01B0 vi\u1EC7n", icon: "Image", path: "/media", permissionSlug: "media:view", appSlug: null, position: 91 },
      { id: ulid(), label: "\u1EE8ng d\u1EE5ng", icon: "Grid", path: "/apps", permissionSlug: "apps:view", appSlug: null, position: 92 },
      { id: ulid(), label: "API Keys", icon: "Key", path: "/api-keys", permissionSlug: "api_keys:view", appSlug: null, position: 93 },
      { id: ulid(), label: "C\xE0i \u0111\u1EB7t", icon: "Settings", path: "/settings", permissionSlug: "settings:view", appSlug: null, position: 98 },
      { id: ulid(), label: "Nh\u1EADt k\xFD", icon: "FileText", path: "/audit", permissionSlug: "audit:view", appSlug: null, position: 99 }
    ];
